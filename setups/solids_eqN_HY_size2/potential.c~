...
void compute_potential(real dt) {
  ...
  DevMemcpyH2D(Sys->vx_gpu, Sys->vx_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->vy_gpu, Sys->vy_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->vz_gpu, Sys->vz_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->mass_gpu, Sys->mass_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->sigmarms_gpu, Sys->sigmarms_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->eccrms_gpu, Sys->eccrms_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->incrms_gpu, Sys->incrms_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->masscore_gpu, Sys->masscore_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->massenv_gpu, Sys->massenv_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->accsolids_gpu, Sys->accsolids_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->rcore_gpu, Sys->rcore_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->masscrit_gpu, Sys->masscrit_cpu, sizeof(real)*(Sys->nb+1));
  DevMemcpyH2D(Sys->accgas_gpu, Sys->accgas_cpu, sizeof(real)*(Sys->nb+1));
#endif
