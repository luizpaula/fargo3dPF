...
void CreateFields() {
  ...
  Sigmam  = CreateField("soldens"   , SIGMAM, 0,0,0);
  Ecc  = CreateField("solecc"   , ECC, 0,0,0);
  Inc  = CreateField("solinc"   , INC, 0,0,0);

#ifdef COREACCRETION
  Rhogas = CreateField("rhogas",0, 0,0,0);
  Numol = CreateField("numol",0, 0,0,0);
  Reymol = CreateField("reymol",0, 0,0,0);
  Dedt = CreateField("dedt",0, 0,0,0);
  Didt = CreateField("didt",0, 0,0,0);
  Eccquad = CreateField("Eccquad",0, 0,0,0);
  Incquad = CreateField("Incquad",0, 0,0,0);
#endif

#ifdef GASACCRETION
  DeltaM = CreateField("deltam",0, 0,0,0);
#endif
