...
struct planetary_system {
  ...
  real *sigmarms;               /**< mean density of solids in the feeding zone */
  real *sigmarms_cpu;           /**< mean density of solids in the feeding zone */ 
  real *sigmarms_gpu;           /**< mean density of solids in the feeding zone */
  real *eccrms;                 /**< quadratic mean excentricity of solids in the feeding zone */
  real *eccrms_cpu;             /**< quadratic mean excentricity of solids in the feeding zone */
  real *eccrms_gpu;             /**< quadratic mean excentricity of solids in the feeding zone */
  real *incrms;                 /**< quadratic mean inclination of solids in the feeding zone */
  real *incrms_cpu;             /**< quadratic mean inclination of solids in the feeding zone */
  real *incrms_gpu;             /**< quadratic mean inclination of solids in the feeding zone */
  real *masscore;		/**< Masses of the core */
  real *masscore_cpu;		/**< Masses of the core */
  real *masscore_gpu;		/**< Masses of the core */
  real *massenv;		/**< Masses of the gas envelope */
  real *massenv_cpu;		/**< Masses of the gas envelope */
  real *massenv_gpu;		/**< Masses of the gas envelope */
  real *rcore;                  /**< radius of core */
  real *rcore_cpu;              /**< radius of core */
  real *rcore_gpu;              /**< radius of core*/
  real *rcap;                  /**< radius of capture */
  real *rcap_cpu;              /**< radius of capture */
  real *rcap_gpu;              /**< radius of capture*/
  real *accsolids;              /**< accretion tax of solids */
  real *accsolids_cpu;          /**< accretion tax of solids */
  real *accsolids_gpu;          /**< accretion tax of solids */
  real *accgas;                 /**< accretion tax of gas */
  real *accgas_cpu;             /**< accretion tax of gas */
  real *accgas_gpu;             /**< accretion tax of gas */
  real *masscrit;	        /**< Masses crit of the core */
  real *masscrit_cpu;		/**< Masses crit of the core */
  real *masscrit_gpu;		/**< Masses crit of the core */
  ...
  real *vz_cpu;
  real *vz_gpu;
  real *deltaM;		        /**< accreted mass of the planet */
  real *deltaM_cpu;
  real *deltaM_gpu;
