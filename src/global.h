...
boolean AccretionRunaway = NO;
real    ratio_KH_max = 1.0;
...
real VZplanet;
real MplanetVirtual;
real SigmarmsVirtual;
real EccrmsVirtual;
real IncrmsVirtual;
real McoreVirtual;
real RcoreVirtual;
real RcapVirtual;
real AccretionsolidsVirtual;
real MenvVirtual;
real McritVirtual;
real AccretiongasVirtual;
...
void (*Computerhogas)();
void (*Computenumol)();
void (*Computegasdragecc)();
void (*Computegravecc)();
void (*Computegasdraginc)();
void (*Computegravinc)();
void (*Computereymol)();
void (*Updateecc)(real);
void (*Updateinc)(real);
void (*Computeaccretionsolids)(real,int);
void (*Computeaccretionsolidsequilibrium)(real,int);
void (*Accretiongas)(real,int);
