...
ex void Computerhogas_cpu();
ex void Computenumol_cpu();
ex void Computegasdragecc_cpu();
ex void Computegravecc_cpu();
ex void Computegasdraginc_cpu();
ex void Computegravinc_cpu();
ex void Computereymol_cpu();
ex void Updateecc_cpu(real);
ex void Updateinc_cpu(real);
ex void Computeaccretionsolids_cpu(real,int);
ex void Computeaccretionsolidsequilibrium_cpu(real,int);
ex void Accretiongas_cpu(real,int);
ex void InitAccSolids();
ex void InitAccSolidsEquilibrium();
...
ex void WritePlanetFileAccretionSolids (int, int, boolean);
...
ex void Computerhogas_gpu();
ex void Computenumol_gpu();
ex void Computegasdragecc_gpu();
ex void Computegravecc_gpu();
ex void Computegasdraginc_gpu();
ex void Computegravinc_gpu();
ex void Updateecc_gpu(real);
ex void Updateinc_gpu(real);
ex void Computereymol_gpu();
ex void Computeaccretionsolids_gpu(real,int);
ex void Computeaccretionsolidsequilibrium_gpu(real,int);
ex void Accretiongas_gpu(real,int);
